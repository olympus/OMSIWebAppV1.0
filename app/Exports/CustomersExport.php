...
class CustomersExport implements FromArray, WithHeadings, WithStyles, WithColumnWidths, ShouldAutoSize
{
    protected $customers;
    ...
    public function array(): array
    {
        ...
        foreach ($this->customers as $customer) {
            ...
            $allBranches = implode(',', array_unique($branch));
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        foreach ($data as $key => $value) {
            ...
            if ($key % 2 == 0) {
                $sheet->getStyle('A' . $rowNumber . ':P' . $rowNumber)->applyFromArray([
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,

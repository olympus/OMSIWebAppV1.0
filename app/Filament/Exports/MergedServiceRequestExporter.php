...
class MergedServiceRequestExporter extends Exporter
{
...
//            ExportColumn::make('source'),
    ...
    {
        $body = 'Your merged service request export has completed and ' . Number::format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';

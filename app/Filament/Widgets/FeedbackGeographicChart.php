...
class FeedbackGeographicChart extends ChartWidget
{
    use HasFiltersSchema, InteractsWithForms;


    protected ?string $heading = '4. Feedback on service request (Geographic)';
    ...
    protected function getData(): array
    {
        ...
        $chart72 = \App\Charts\GetCharts::chart72($daterange, $services_obj);

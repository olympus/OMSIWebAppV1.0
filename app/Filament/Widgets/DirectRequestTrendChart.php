...
class DirectRequestTrendChart extends ChartWidget
{
    use HasFiltersSchema, InteractsWithForms;


    protected ?string $heading = '6. Direct Requests Trend (Geographic)';
    ...
    protected function getData(): array
    {
        ...
        $chart83 = \App\Charts\GetCharts::chart83($daterange, $direct_requests, $months12, $chart_months, $date_to1);
        ...
        $index = 0;
        foreach ($chart83 as $region => $data) {
            $datasets[] = [
                'label' => $region,

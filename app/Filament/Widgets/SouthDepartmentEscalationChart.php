...
class SouthDepartmentEscalationChart extends ChartWidget
{
    use HasFiltersSchema, InteractsWithForms;

    protected ?string $heading = 'Escalation by Department';
    ...
    protected function getData(): array
    {
        ...
        return [
            'datasets' => [
                [
                    'label' => 'Escalated',
                    'data' => $filtereddata['chart41']['Escalated'],
                    'backgroundColor' => 'rgba(255, 99, 132, 0.8)',
                ],
                [
                    'label' => 'Not Escalated',
                    'data' => $filtereddata['chart41']['NotEscalated'],

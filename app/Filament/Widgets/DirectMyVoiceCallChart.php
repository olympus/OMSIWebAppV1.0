...
class DirectMyVoiceCallChart extends ChartWidget
{
    use HasFiltersSchema, InteractsWithForms;


    protected ?string $heading = '5. Direct and My voice call';
    ...
    protected function getData(): array
    {
        ...
        $chart81 = \App\Charts\GetCharts::chart81_combined($daterange, $direct_requests, $services_obj, $months12, $chart_months, $date_to1);

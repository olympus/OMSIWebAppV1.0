...
<?php
	$feedback = \App\Models\Feedback::where('request_id',$servicerequest->id)->first();
	function convert2stars($value){
		if($value==1){return "*";}
		elseif($value==2){return "* *";}
		elseif($value==3){return "* * *";}
		elseif($value==4){return "* * * *";}
		elseif($value==5){return "* * * * *";}
		elseif($value== 0 || empty($value)){return "";}
	}
?>
<div class="col-md-12">
<p class="text-center" style="background-color:#000080; padding:7px; color:white; border-radius:10px;"><font size=4><b>Customer Feedback</b></font></p>
<table class="table table-striped" border>
<col width="30%">
<col width="70%">
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=5 color=white><b>Received on</b></font></div>
<td>
<div align=center><font size=5>{{$feedback->created_at}}</font></div>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=5 color=white><b>Response Speed</b></font></div>
<td>
<div align=center><font size=5>{{ convert2stars($feedback->response_speed) }}</font></div>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=5 color=white><b>Quality of Response</b></font></div>
<td>
<div align=center><font size=5>{{ convert2stars($feedback->quality_of_response) }}</font></div>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=5 color=white><b>App Experience</b></font></div>
<td>
<div align=center><font size=5>{{ convert2stars($feedback->app_experience) }}</font></div>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=5 color=white><b>Olympus Staff Performance</b></font></div>
<td>
<div align=center><font size=5>{{ convert2stars($feedback->olympus_staff_performance) }}</font></div>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=5 color=white><b>Remarks</b></font></div>
<td>
<div align=center><font size=5>{{ $feedback->remarks }}</font></div>
</table>
</div>
...
<div class="col-md-12">
<p class="text-center" style="background-color:#000080; padding:7px; color:white; border-radius:10px;"><font size=4><b>Request Details</b></font></p>
<table class="table table-striped" border>
<col width="30%">
<col width="70%">
<tr valign=top>
...
<div class="col-md-12">
<p class="text-center" style="background-color:#000080; padding:7px; color:white; border-radius:10px;"><font size=4><b>Profile</b></font></p>
<table class="table table-striped" border>
<col width="30%">
<col width="70%">
<tr valign=top>
...
@endphp
<div class="col-md-12">
<p class="text-center" style="background-color:#000080; padding:7px; color:white; border-radius:10px;"><font size=4><b>Assigned Olympus Executive</b></font></p>
<table class="table table-striped" border>
<col width="30%">
<col width="70%">
<tr valign=top>
...
<div class="col-md-12">
	<p class="text-center" style="background-color:#000080; padding:7px; color:white; border-radius:10px;"><font size=4><b>Request Timeline</b></font></p>
	<table class="table table-striped" border>
	<col width="50%">
	<col width="50%">
	<tr valign=top>
...
@endphp
<div class="col-md-12">
<p class="text-center" style="background-color:#000080; padding:7px; color:white; border-radius:10px; width:100%"><font size=4><b>Hospital {{$count}}</b></font></p>

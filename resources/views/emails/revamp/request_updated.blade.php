...
<br>
<font size=4><b><u>Profile:</u></b></font>
<table border>
<tr valign=top>
<td bgcolor=#000080>
...
@endphp
@if($servicerequest->request_type == 'service')
<font size=4><b><u>Assigned Olympus Engineer:</u></b></font>
<table border>
<tr valign=top>
<td bgcolor=#000080>
...
<tr valign=top>
<td bgcolor=#000080><div align=center><font size=3 color=white><b>Name</b></font></div>
<td><div align=center><font size=3>{{$assigned_person->name}}</font>
<tr valign=top>
<td bgcolor=#000080><div align=center><font size=3 color=white><b>Mobile Number</b></font></div>
<td><div align=center><font size=3>{{$assigned_person->mobile}}</font>
<tr valign=top>
<td bgcolor=#000080><div align=center><font size=3 color=white><b>Email:</b></font></div>
<td><div align=center><font size=3>{{$assigned_person->email}}</font>
</table>
@if($oldData->employee_code!=$servicerequest->employee_code)
@php
	$old_person = \App\Models\EmployeeTeam::where('employee_code',$oldData->employee_code)->first();
@endphp
<font size=4><b><u>Re-Assigned from:</u></b></font>
<table border>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=3 color=white><b>Assigned on</b></font></div>
<td>
<div align=center><font size=3>{{$oldData->updated_at}}</font></div>
<tr valign=top>
<td bgcolor=#000080><div align=center><font size=3 color=white><b>Name</b></font></div>
<td><div align=center><font size=3>{{$old_person->name}}</font>
<tr valign=top>
<td bgcolor=#000080><div align=center><font size=3 color=white><b>Mobile Number</b></font></div>
<td><div align=center><font size=3>{{$old_person->mobile}}</font>
<tr valign=top>
<td bgcolor=#000080><div align=center><font size=3 color=white><b>Email:</b></font></div>
<td><div align=center><font size=3>{{$old_person->email}}</font>
</table>
@endif
@else
<font size=3 color=black><b>Assigned Olympus Executive:</b></font>
<table border>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=3 color=white><b>Assigned on</b></font></div>
...
@php
	$old_person = \App\Models\EmployeeTeam::where('employee_code',$oldData->employee_code)->first();
@endphp
<font size=4><b><u>Re-Assigned from:</u></b></font></div>
<table border>
<tr valign=top>
<td bgcolor=#000080>
<div align=center><font size=3 color=white><b>Assigned on</b></font></div>
